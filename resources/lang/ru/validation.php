...
return [
    ...
    */
    ...
    'admin' => [
        ...
        'creating'=>'Панель создания нового продукта',
        'edition'=>'Панель редактирования',
        'action'=>'Действие',
        'change'=>'Изменить',
        'delete'=>'Удалить',
    ...
    'auth'=> [
        ...
        'login'=>'Войти',
        'logout'=>'Выйти',
        'home'=>'На главную станицу',
        'reset_password'=>'Восстановление пароля',
        'authorization'=>'Авторизация',
        'registration'=>'Регистрация',
        'send_reset_password'=>'Отправить ссылку на восстановление пароля',
    ],
    'product' => [
        'id'=>'Номер ID продукта: ',
        'name'=>'Имя',
        ...
        'info'=>'Узнать больше',
        'products'=>'Продукты',
        'none'=>'В данный момент товары отсутствуют',
        'come_back'=>'Вернутся на главную'
    ]
];